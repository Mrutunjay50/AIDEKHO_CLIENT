...
const Dashboard = () => {
  const { toolData, plugins, categories, handleExportCSV, pluginCount, gptCount, aiCount, handleExportCSVUsers} = useTool();
  ...
  return (
    ...
    <div className='flex flex-wrap gap-10 m-10 '>
      <div className=' w-[25%] h-[18vh] border-2 rounded-lg flex justify-center items-center text-[24px] font-medium bg-slate-200 text-center'>TotalTools <br/> {aiCount}</div>
      <div className=' w-[25%] h-[18vh] border-2 rounded-lg flex justify-center items-center text-[24px] font-medium bg-slate-200 text-center'>Total Plugins <br/> {pluginCount}</div>
...
<div onClick={() => handleExportCSVUsers()} className=' w-[25%] h-[18vh] border-2 rounded-lg flex justify-center items-center text-[24px] font-medium bg-slate-200 text-center cursor-pointer hover:bg-[#23CD15]'>TotalUsers <br/> {noOfUsers}</div>
