        ...
        <div className="min-h-[100vh] mt-[-12vh] pt-[12vh] bgcolor">
          <div className="navbg mt-[-12vh] pt-[12vh]">
            ...
            <div className=" md:items-center md:justify-center   md:flex hidden">
              <hr className="w-[380px] md:w-[570px] border-[#23CD15] translate-y-[65px] md:translate-y-[82px] border-t-[11px] rounded-2xl" />
            </div>
            <h1 className="font-poppins md:px-0  text-[32px] md:text-[50px] heading-color font-semibold text-center translate-y-[20px]">
              Popular OpenAI GPTs
            </h1>
          </div>
